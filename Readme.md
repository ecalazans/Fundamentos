...
[x] Implementar o modelo de empréstimo (getLoan) na classe CompanyAccount
  - Os valores do saldo deve ser acrescido, de acordo com o valor informado para empréstimo
